...
<section class="page-section page-restaurant">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 bg-main">
        <div class="p-3">
          ...
          <div class="row border border-white px-3 px-lg-5 pt-5">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
              <div class="d-flex mb-5">
                ...
                <div class="py-1 px-2">
                  <p class="h5 text-uppercase"><?php esc_html_e($advantage['title']); ?></p>
                  <p class="text-white m-0"><?php print($advantage['desc']); ?></p>
                </div>
              </div>
            </div>
            <?php endforeach; ?>
  ...
  <div class="container">
    <div id="gallery" class="row justify-content-center py-5">
      <div class="col-12 col-lg-10 text-center">
        ...
        <p class="fs-5 fw-normal lh-lg w-75 mx-auto"><?php the_field('gallery_caption'); ?></p>
      </div>
    </div>
  </div>
  <div class="container-fluid p-0">

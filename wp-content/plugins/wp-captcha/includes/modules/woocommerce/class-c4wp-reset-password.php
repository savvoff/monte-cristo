<?php
/**
 * The functionality that handles the display of the Captcha form on the Woocommerce Reset Password Form.
 * @package  	WP Captcha
 * @subpackage  WP Captcha/modules/woocommerce/class-c4wp-reset-password
 * @author   	Devnath verma <devnathverma@gmail.com>
 */

/**
 * Class responsible for generating the display of the Captcha on Woocommerce Reset Password Form.
 * Gets called only if the "display captcha on Woocommerce Reset Password Form" option is checked in the back-end
 * @package  	WP Captcha
 * @version  	1.0.0
 * @author   	Devnath verma <devnathverma@gmail.com>
 */
 
class C4WP_Woocommerce_Reset_Password {
	...
	public function __construct( $c4wp_plugin_options ) {
		...
		// adds the required HTML for the captcha to the Woocommerce Reset Password Form
		add_action( 'woocommerce_lostpassword_form', array( $this, 'c4wp_display_captcha' ) );
		
		// validate the captcha answer on Woocommerce Reset Password Form
		add_action( 'lostpassword_post', array( $this, 'c4wp_validation_check' ), 10, 3 );	
	}
	
	/**
	 * Generate captcha to Provide a public-facing view for the plugin on Woocommerce Reset Password Form.
	 * @package  WP Captcha
	 * @version  1.0.0
	 * @author   Devnath verma <devnathverma@gmail.com>
	 */
	...
	/**
	 * This function checks validations of the captcha posted with Woocommerce Reset Password Form.
	 * @package  WP Captcha
	 * @version  1.0.0
	 * @author   Devnath verma <devnathverma@gmail.com>
	 */

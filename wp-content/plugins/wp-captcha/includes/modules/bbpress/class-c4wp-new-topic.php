<?php
/**
 * The functionality that handles the display of the Captcha on the BBPress New Topic Form.
 * @package  	WP Captcha
 * @subpackage  WP Captcha/modules/bbpress/class-c4wp-new-topic
 * @author   	Devnath verma <devnathverma@gmail.com>
 */

/**
 * Class responsible for generating the display of the Captcha on BBPress New Topic Form.
 * Gets called only if the "display captcha on BBPress New Topic Form" option is checked in the back-end
 * @package  	WP Captcha
 * @version  	1.0.0
 * @author   	Devnath verma <devnathverma@gmail.com>
 */
 
class C4WP_BBPress_New_Topic {
	...
	public function __construct( $c4wp_plugin_options ) {
		...
		// adds the required HTML for the captcha to the BBPress New Topic Form
		add_action('bbp_theme_after_topic_form_content', array( $this, 'c4wp_display_captcha' ) );
		
		// validate the captcha answer on BBPress New Topic Form
		add_action('bbp_new_topic_pre_extras', array( $this, 'c4wp_validation_check' ) );	
	}
	
	/**
	 * Generate captcha to Provide a public-facing view for the plugin on BBPress New Topic Form.
	 * @package  WP Captcha
	 * @version  1.0.0
	 * @author   Devnath verma <devnathverma@gmail.com>
	 */
	...
	/**
	 * This function checks validations of the captcha posted with BBPress New Topic Form.
	 * @package  WP Captcha
	 * @version  1.0.0
	 * @author   Devnath verma <devnathverma@gmail.com>
	 */
